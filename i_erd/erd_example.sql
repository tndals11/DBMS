...
create table professors (
    ...
    professors_major varchar(50) not null,
	professors_location varchar(100) not null
);

drop tables Professors;
drop tables courses;
...
create table enrollments (
  ...
  student_id int,
  courses_id int,
  enrollments_date int,
  enrollments_semester int,
